...
myst_html_meta = {
    "description": "Use FraudLabs Pro Scala SDK to screen the order transaction for payment fraud.",
    "keywords": "FraudLabs Pro, Fraud Prevention, Fraud Detection, Scala",
...
html_title = "FraudLabs Pro Scala"

# html_baseurl = "https://fraudlabspro-scala.readthedocs.io/en/latest/"